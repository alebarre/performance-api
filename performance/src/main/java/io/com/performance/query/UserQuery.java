...
public class UserQuery {
    public static final String SELECT_URL_FROM_VERIFFICATIONS = "SELECT url FROM  resetpasswordverifications LIMIT 1";
    ...
    public static final String SELECT_ADDRESS_BY_CUSTOMER_ID = "SELECT * FROM Address WHERE customere_id = :id";
}
